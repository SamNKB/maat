...
8. **Subtipo `rank`** (decisão de 2026-08-16: criar; **em consolidação**): ordinal com k ≈ n (colocação na maratona: 1º…40.000º, cada valor único) vira um subtipo próprio — pode ser lida como id, como quantitativa discreta ou como ordinal, e por isso merece rota própria. Pendências antes de codificar:
